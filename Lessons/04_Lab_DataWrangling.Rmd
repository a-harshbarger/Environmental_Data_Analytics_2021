...
NTL.phys.data.1990s.Tues <- filter(NTL.phys.data, year4 %in% c(1990:1999) & lakename =="Tuesday Lake")

```
Question: Why don't we filter using row numbers?

> Answer: Could cause a reproduceabilty issue because row numbers may change as you arrange/otherwise wrangle the dataset
...
View(NTL.phys.data.90sjul.Tues)
