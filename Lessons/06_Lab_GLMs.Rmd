...
ozone_density <- ggplot(data = EPAair, aes(x = Ozone, fill = Year)) +
  geom_density(alpha = 0.5)
print(ozone_density)

ozone_box <- ggplot(data = EPAair, aes(x = Year, y = Ozone)) +
  geom_boxplot()
print(ozone_box)

ozone_violin <- ggplot(data = EPAair, aes(x = Year, y = Ozone)) +
...
lm_PM <- lm(data = EPAair, PM2.5 ~ Ozone)
summary(lm_PM)
...
# lm_scatter <- ggplot(data = EPAair, aes(x = Ozone, y = PM2.5)) +
#   geom
