...
vector1[3] # 3rd element in vector1 (5)

# Matrices ----
matrix1 <- matrix(1:20, nrow = 5,ncol = 4) # matrix with 5 rows and 4 columns of integers 1-20
matrix1
matrix2 <- matrix(1:20, nrow = 5, ncol = 4, byrow = TRUE) # matrix with same dimensions as above, populated across rows instead of down columns
matrix2
matrix3 <- matrix(1:20, nrow = 5, ncol = 4, byrow = TRUE, # return after comma continues the line
                  dimnames = list(c("uno", "dos", "tres", "cuatro", "cinco"), 
                                  c("un", "deux", "trois", "cat"))) # names rows and columns of matrix

matrix1[4, ] # view 4th row of matrix1
matrix1[ , 3] # view 3rd column of matrix1
matrix1[c(12, 14)] # view 12th and 14th elements of matrix1
matrix1[c(12:14)] # view 12th through 14th elements of matrix1
matrix1[2:4, 1:3] # view section of matrix1 between rows 2-4 and columns 1-3

cells <- c(1, 26, 24, 68)
rnames <- c("R1", "R2")
cnames <- c("C1", "C2") 
matrix4 <- matrix(cells, nrow = 2, ncol = 2, byrow = TRUE,
  dimnames = list(rnames, cnames)) # create a matrix using values and names defined in previous 3 lines
matrix4
...
dataframe1 <- data.frame(d,e,f) # bind 3 vectors into df
names(dataframe1) <- c("ID","Color","Passed"); View(dataframe1) # name columns and view df

dataframe1[1:2,] # view first 2 rows of df
dataframe1[c("ID","Passed")] # select columns ID and passed
dataframe1$ID
...
durham_high_f <- c(48,52,52,50,51,51,50,45,39,37)

durham_low_f <- c(24,38,27,31,28,35,36,30,21,20)
...
durham_high_c <- convert.to.c(temp.f=durham_high_f); durham_high_c
durham_low_c <- convert.to.c(temp.f=durham_low_f); durham_low_c
...
```{r}
durham_forecast <- data.frame(durham_high_f, durham_high_c, durham_low_f, durham_low_c)
...
#sd(durham_forecast) #does not work for whole df

summary(durham_forecast$durham_high_f)
sd(durham_forecast$durham_high_f)
```
